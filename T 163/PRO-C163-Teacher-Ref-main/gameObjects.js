AFRAME.registerComponent("wire-fence", {init: function () {posX = -20;posZ = 85;
    ...
    for (var i = 0; i < 10; i++) {
      ...
      posX = posX + 5; posY = 2.5; posZ = posZ - 10;
...
AFRAME.registerComponent("boxes", {
  schema: { height: { type: "number", default: 3 }, width: { type: "number", default: 3 }, depth: { type: "number", default: 3 },},
  init: function () {
    for (var i = 0; i < 20; i++) {
